...
def test_uvx_available_shows_cold_cache_message():
    ...
    with patch("sqlcg.cli.commands.install.shutil.which") as mock_which:
        ...
        with patch("sqlcg.cli.commands.install.Path") as MockPath:
            ...
            with patch("sqlcg.cli.commands.install.console") as mock_console:
                ...
                found_cold_cache = any(
                    "cold" in str(call).lower() or "download" in str(call).lower() or "first" in str(call).lower()
    ...
    with patch("sqlcg.cli.commands.install.shutil.which") as mock_which:
        ...
        with patch("sqlcg.cli.commands.install.Path") as MockPath:
            ...
            with patch("sqlcg.cli.commands.install.console") as mock_console:
                ...
                calls_str = str(mock_console.print.call_args_list)
                found_sqlcg = any("sqlcg" in str(call) for call in mock_console.print.call_args_list)
